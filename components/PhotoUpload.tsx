...
const styles = StyleSheet.create({
  ...
  requiredHint: { fontSize: 12, color: Colors.error, fontWeight: '600' },
  completeHint: { fontSize: 12, color: Colors.success, fontWeight: '600' },
  ...
  slotDesc: { fontSize: 13, color: Colors.textMuted, marginTop: 2 },
  slotHint: { fontSize: 11, color: Colors.textMuted, marginTop: 4 },
  previewContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    padding: 8,
  ...
  previewInfo: { flex: 1 },
  removeBtn: { fontSize: 13, color: Colors.error, fontWeight: '600', marginTop: 4 },
